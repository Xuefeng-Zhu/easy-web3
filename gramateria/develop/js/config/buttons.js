import { prepareDeployContent, exportZip, getGlobalJsCss } from './../helpers';
    ...
    command: (editor, sender) => {
      ...
      const form = `
            ...
            <form id="deploy-form" class="gram-form">
                ...
                <h4>Web3 Storage</h4>
                <div class="form-group">
                    <label>Token <span class="required">*</span> <a target="_blank" href="https://app.netlify.com/user/applications#personal-access-tokens"><span class="fa fa-question"></span></a></label>
                ...
                <div class="form-group deploy-result hide">
                  <b>Deployed to </b><a href="" target="_blank"></a>
                </div>
            </form>
            `;
      ...
      deployForm.addEventListener('submit', async (e) => {
        ...
        const cid = await prepareDeployContent(data);
        const siteLink = `https://${cid}.ipfs.dweb.link/`;
        const deployedResult = document.querySelector('.deploy-result');
        deployedResult.classList.remove('hide');
        const deployedAnchor = deployedResult.querySelector('a');
        deployedAnchor.href = siteLink;
        deployedAnchor.text = siteLink;
      });
    },
    attributes: {
      title: 'Deploy',
